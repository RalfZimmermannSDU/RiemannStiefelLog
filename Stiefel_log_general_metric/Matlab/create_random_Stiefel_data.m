...
function [U0, U1, Delta] =...
    create_random_Stiefel_data(s, n, p, dist, alpha)
%-------------------------------------------------------------
% create a random data set 
% U0, U1 on St(n,p),
%  Delta on T_U St(n,p) with Riemannian norm 'dist',
